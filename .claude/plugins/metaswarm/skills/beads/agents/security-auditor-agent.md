...
**File**: `src/lib/ (example path)services/ (example path)search.service.ts:45`
...
**File**: `src/api/ (example path)routes/ (example path)contacts.ts:23`
...
**File**: `src/lib/ (example path)services/ (example path)gmail.service.ts:89`
...
- `src/api/ (example path)routes/ (example path)<route>` - Auth, input validation
- `src/lib/ (example path)services/ (example path)<service>` - Data handling
